...

{
  ...
  "displayName": "JL - Amplitude Analytics Browser \u0026 SR SDK",
  "brand": {
  ...
  },
  {
    ...
    "subParams": [
      ...
      },
      {
        ...
        "help": "If you select \u003cstrong\u003eUse default values\u003c/strong\u003e, then the initialization is done with \u003ca href\u003d\"https://www.docs.developers.amplitude.com/data/sdks/browser-2/#configuration\"\u003ethe default values\u003c/a\u003e.\u003cbr/\u003e\u003cbr/\u003e\nYou can also select a \u003cstrong\u003e{{GTM variable}}\u003c/strong\u003e from the list, which needs to return an object that has the key-value pairs you want to configure the instance with. You can find the key-value pairs following \u003ca href\u003d\"https://www.docs.developers.amplitude.com/data/sdks/browser-2/#configuration\"\u003ethis example\u003c/a\u003e.\u003cbr/\u003e\u003cbr/\u003eFinally, you can \u003cstrong\u003eSet configuration manually\u003c/strong\u003e in the tag itself, by selecting the corresponding option.",
        "macrosInSelect": true,
        "selectItems": [
          {
      ...
      },
      {
        ...
        "subParams": [
          {
            "type": "GROUP",
            "name": "userAgentEnrichmentOptions",
            ...
            "subParams": [
              {
                "type": "CHECKBOX",
                "name": "osName",
                "checkboxText": "Enrich os_name using client user agent enrichment",
                "simpleValueType": true,
                "defaultValue": true
              },
              {
    ...
    "subParams": [
      {
        ...
        "subParams": [
          {
            ...
            "displayName": "Session Replay Init Options",
            "groupStyle": "NO_ZIPPY",
            "subParams": [
              {
                "type": "TEXT",
                ...
                "simpleValueType": true,
                "help": "Use this option to control how many sessions to select for replay collection. The number should be a decimal between 0 and 1, for example 0.4, representing the fraction of sessions to have randomly selected for replay collection. Over a large number of sessions, 0.4 would select 40% of those sessions.",
                "defaultValue": 1,
                "valueValidators": [
                  {
                    "type": "DECIMAL"
              ...
              {
                "type": "TEXT",
                "name": "forceSessionTracking",
                "displayName": "Force Session Tracking",
                "simpleValueType": true,
                "help": "Beginning with plugin version 1.1.0, Session Replay no longer requires Session Start and Session End events, but does capture them by default. To disable capture of these events, set forceSessionTracking to false.",
                "defaultValue": true
              }
            ],
            "enablingConditions": [
              {
                "paramName": "enableSessionReplay",
                "paramValue": true,
                "type": "EQUALS"
              }
            ]
        ...
        "help": "Check this box to enable Session Replay to record your users sessions. \u003ca href\u003d\"https://amplitude.com/docs/session-replay\"\u003eRead more\u003c/a\u003e."
      }
    ],
    "enablingConditions": [
      {
...
const WRAPPER_URL = 'https://skink-feasible-elephant.ngrok-free.app/src/analytics-browser-sr-gtm-wrapper.js';
...
// Generate inititalisation options for Session Replay plugin
// - sampleRate: Defined in data.sampleRate (defaults to 1)
// - forceSessionTracking: Defined in data.forceSessionTracking (default to true)
const generateSRInitOptions = () => {

  const SROptions = {
    forceSessionTracking:data.forceSessionTracking || true,
    sampleRate: data.sampleRate || 1
  };
  ...
  switch (data.type) {
    case 'init':
      if (data.enableSessionReplay) {
        log(LOG_PREFIX + 'Info: initialisation called with SR enabled and key ' + data.apiKey);
        _amplitude(instanceName, 'init', data.apiKey, initUserId, generateConfiguration(),generateSRInitOptions());
      }
      else {
        log(LOG_PREFIX + 'Info: initialisation called with key ' + data.apiKey);
...
injectScript(WRAPPER_URL, onsuccess, onfailure, 'amplitude');
      ...
      "param": [
        {
          ...
          "value": {
            ...
            "listItem": [
              {
                "type": 1,
                "string": "https://skink-feasible-elephant.ngrok-free.app/src/analytics-browser-sr-gtm-*"
              }
            ]
          }
        }
